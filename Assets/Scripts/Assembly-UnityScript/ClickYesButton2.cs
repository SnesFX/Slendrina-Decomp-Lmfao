...
[Serializable]
public class ClickYesButton2 : MonoBehaviour
{
	...
	public virtual void Update()
	{
		...
		for (int length = touches.Length; i < length; i++)
		{
			...
			{
				PlayerPrefs.SetInt("lv3Unlocked", 1);
				cellar3Costs = PlayerPrefs.GetInt("stcPoints") - cellar3Costs;
				PlayerPrefs.SetInt("stcPoints", cellar3Costs);
